...
- (void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event {
	...
	if((x == 0 && angle3 >= -90 && angle3 < -40 && currentPoint.y < previousPoint.y) ||(x == 0 && angle2 > 80 && currentPoint.y < previousPoint.y )) //if moving straight up
	{
	...
	if(x == 2 && angle3 > 40 && angle3 <= 90 && currentPoint.y > previousPoint.y) //if moving down right
	{
		lineLengthSoFar += distanceBetweenPoints(previousPoint, currentPoint);
		if (lineLengthSoFar > 10)
			x = 3;
	...
	if(x == 4 && angle3 < -40 && angle3 >= -90 && currentPoint.y < previousPoint.y) //if moving up right
	{
		lineLengthSoFar += distanceBetweenPoints(previousPoint, currentPoint);
		if (lineLengthSoFar > 10)
			x = 5;
	...
	if((x == 6 && angle3 <= 90 && angle3 > 40 && currentPoint.y > previousPoint.y) ||(x == 6 && angle2 > 80 && currentPoint.y > previousPoint.y )) //if moving straight down
	{
		lineLengthSoFar += distanceBetweenPoints(previousPoint, currentPoint);
		if (lineLengthSoFar > 10)
			x = 7;
